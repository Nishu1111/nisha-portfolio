...
export default function ContactMe({}: Props) {
  ...
  return (
    <div className='h-screen flex-col md:text-left md:flex-row max-w-7xl px-10  relative items-center flex text-center justify-evenly mx-auto '>
        ...
        <div className='flex mt-10  flex-col space-y-10'>
            ...
            <div className='space-y-10'>
                ...
                <div className='flex items-center justify-center space-x-5'>
                  ...
                  <p className='text-2xl'>nishunicks113@gmail.com</p>
                </div>
                <div className='flex items-center justify-center space-x-5'>
